To Do List Google Chrome extension in which user can set date, time and category for their tasks and edit their 
existing tasks. Categories consist of general, private, work, shopping, done, archive and overdue category. There is 
a reminder for tasks that are due on today's day. All user data is stored in chrome.storage.sync, and automatically 
synced to any Chrome browser that the user is logged into.
